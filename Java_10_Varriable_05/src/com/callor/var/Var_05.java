...
public class Var_05 {
	public static void main( String[] args) {
		...
		String strName = null; // 선언된 문자열 형 변수를 clear 한다.
		
		/*
		 * 	1. strNation 이라는 변수를 만들고 값을 비워 놓는다.
		 ...
		 * 2. 이 값은 그냥 데이터가 아니고 다른 기억장소의 주소라는
		 *    표식이 있다.
		 ...
		 * strNation을 다시 만들어라
		 * 문자열은 계속 추가되기 때문에 가급적 +연산을 최소화해야한다.
		 */
		strNation += " 우리나라";
		System.out.println(strNation);
		
		//문자열은 %s를 사용해 printf()로 출력한다.
		System.out.printf( "\t%s\n", strNation);
